...
import { BarChart3, RotateCw, Trophy, Users } from 'lucide-react'
    ...
    <div className="grid gap-6">
      ...
      <div className="grid gap-3 md:grid-cols-4">
        {[
          ...
          ['测验均分', `${summary?.avgScore ?? 0}`, BarChart3],
          ['通过率', `${summary?.passRate ?? 0}%`, BarChart3],
            ...
            {(data?.members ?? []).map((m) => (
              ...
              >
                ...
                <div className="text-sm text-black/70">
                  <div className="text-[11px] uppercase tracking-[0.2em] text-black/40">均分 / 次数</div>
                ...
                <div className="text-sm text-black/70">
                  <div className="text-[11px] uppercase tracking-[0.2em] text-black/40">通过率</div>
                  <div className="mt-1 font-semibold">{m.passRate == null ? '—' : `${m.passRate}%`}</div>
                </div>
                <div className="text-sm text-black/70">
                  <div className="text-[11px] uppercase tracking-[0.2em] text-black/40">最近一次</div>
                  {m.latestScore == null ? (
